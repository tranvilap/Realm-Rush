...
namespace DigitalRuby.SoundManagerNamespace
{
    ...
    public static class SoundManagerExtensions
    {
        ...
        /// <param name="source">Audio source to play</param>
        /// <param name="volumeScale">Additional volume scale</param>
        public static void PlayLoopingMusicManaged(this AudioSource source, float volumeScale)
        {
            SoundManager.PlayLoopingMusic(source, volumeScale, 0f, false);
        }
        ...
        /// <param name="volumeScale">Additional volume scale</param>
        /// <param name="persist">Whether to persist the looping music between scene changes</param>
        public static void PlayLoopingMusicManaged(this AudioSource source, float volumeScale, bool persist)
        {
            SoundManager.PlayLoopingMusic(source, volumeScale, 0f, persist);
        }
        ...
        {
            SoundManager.PlayLoopingMusic(source, volumeScale, fadeSeconds, false);
        }
